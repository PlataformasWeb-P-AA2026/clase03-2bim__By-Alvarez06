...
def listadoPersonalizado(request):
    """
    Listar id, nombre y cantidad de telefonos
    del estudiante
    """
    estudiantes = Estudiante.objects.all()
    titulo = "Listado Estudiantes y Cantidad Números Telefónicos"

    informacion_template = {
        "estudiantes": estudiantes,
        "mititulo": titulo,
    }
    return render(request, "listadoPersonalizado.html", informacion_template)
